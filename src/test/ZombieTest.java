...
public class ZombieTest {
	...
	public void testZombieCreation() {
		final Zombie zombie = new Zombie(DEFAULT_LIFE, DEFAULT_SPEED, DEFAULT_DAMAGE);
	...
	public void testZombieDecoration() {
		final ZombieMaleDecorator maleZombie = new ZombieMaleDecorator(new Zombie(DEFAULT_LIFE, DEFAULT_SPEED, DEFAULT_DAMAGE));
		final ZombieFemaleDecorator femaleZombie = new ZombieFemaleDecorator(new Zombie(DEFAULT_LIFE, DEFAULT_SPEED, DEFAULT_DAMAGE));
