...
public class GunTest {
	...
	public void testGunTypes() {
		final Gun beretta92 = new TexturedGunFactoryImpl().createBeretta92();
		final Gun machineGun = new TexturedGunFactoryImpl().createMachineGun();
		final Gun magmaGun = new TexturedGunFactoryImpl().createMagmaGun();
