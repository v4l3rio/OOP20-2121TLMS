...
public class FollowPlayerComponent_TODELETE extends Component implements Moveable{
	...
	public FollowPlayerComponent_TODELETE(Entity player, PhysicsComponent physics, int speed) {
		this.player = player;
